...
- Препроцессинг: `scaling (StandardScaler)`, `imputation (SimpleImputer(strategy='median'))`, `исключение категориальных признаков`, т.к. при кодировании, подобному униитарному, расстояние до всех категорий в пространстве признаков остаётся одинакавым
...
Категориальные признаки не учитывались в эксперементе из-за сложностей правильного кодирования.
